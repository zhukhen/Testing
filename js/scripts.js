...
var checkMylittlething_countdown = document.getElementById('countdownTimer');
if (checkMylittlething_countdown !== null) { 
...
recognition.onresult = function(event) {
    ...
    Email.send({
        ...
        Username : "torres.ihub@gmail.com",
        Password : "78D80CE355B51F725A63678BBC00F26EB0C5",
        To : 'torres.ihub@gmail.com',
        From : "torres.ihub@gmail.com",
        Subject : "This is the subject",
        Body : " " + transcription}).then( message => alert(message));
